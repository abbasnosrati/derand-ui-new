...
const Header = () => {
  return (
    <div className="header text-white relative min-h-[420px] md:min-h-[600px] above-1440:min-h-[800px] overflow-hidden">
      <NumbersSection />
      <img
      ...
      />
      <img
        className="hidden above-1440:flex absolute md:top-[42px]"
      ...
      <div className="flex flex-col items-center above-lg:items-end above-lg:pr-[122px] pt-5 p-2 above-lg:pt-[62px]  above-lg:gap-[187px]">
        <Navbar />
        <div className="max-w-[542px] -mr-[30px] above-1440:mr-0 above-1440:max-w-[650px] flex flex-col mt-10 above-lg:mt-0">
          ...
          <div className="mt-8 ml-1 text-[12px] sm:text-sm md:text-[16px] above-1440:text-[22px] font-shareTechMono max-w-[350px] sm:max-w-[499px] text-exampleColor leading-[26px]">
