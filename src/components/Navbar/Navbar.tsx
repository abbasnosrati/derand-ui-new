const Navbar = () => {
  ...
  return (
    <div className="flex text-[12px] justify-between md:text-base items-center pl-1 leading-normal font-shareTechMono border-b border-whiteColor text-white w-full max-w-[455px] h-[34px]">
